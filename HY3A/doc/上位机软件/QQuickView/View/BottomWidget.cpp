...
void BottomWidget::initWidget()
{
    ...
    lastBtn->setToolTip(QStringLiteral("上一首"));
    lastBtn->setIcon(QIcon(":/image/View/image/BottomPlay/last.png"));
    ...
    playBtn->setToolTip(QStringLiteral(" 播放"));
    playBtn->setIcon(QIcon(":/image/View/image/BottomPlay/play.png"));
    ...
    nextBtn->setIcon(QIcon(":/image/View/image/BottomPlay/next.png"));
    ...
    playTimeSlider->setStyleSheet("QSlider::groove:horizontal{height: 4px;background: rgb(102,183,255);}\
                                   ...
                                   QSlider::handle:horizontal{width: 14px;background: url(:/image/View/image/BottomPlay/curTimeHandle.png);margin: -5 0 -5 0;}");
	...
	openBtn->setToolTip(QStringLiteral("打开 "));
	openBtn->setStyleSheet("QPushButton{background:transparent;border-image:url(:/image/View/image/open.png)}");

    //volumeSlider = new QSlider;
    //volumeSlider->setOrientation(Qt::Horizontal);
    //volumeSlider->setFixedSize(100,12);
    //volumeSlider->setToolTip(QStringLiteral(" 音量调节"));
    //volumeSlider->setMinimum(0);
    //volumeSlider->setMaximum(100);
    //volumeSlider->setSingleStep(1);
    //volumeSlider->setStyleSheet("QSlider::groove:horizontal{height: 4px;background: rgb(102,183,255);}\
    //                             QSlider::add-page:horizontal{background:#c2c2c4;}\
    //                             QSlider::handle:horizontal{width: 12px;background: url(:/image/View/image/BottomPlay/volumeHandle.png);margin: -4 0 -4 0}");
    ...
    playModeBtn->setToolTip(QStringLiteral(" 顺序播放 "));
    playModeBtn->setStyleSheet("QPushButton{background:transparent;border-image:url(:/image/View/image/BottomPlay/Sequential.png)}");

    //lyricBtn = new QPushButton;
    //lyricBtn->setFixedSize(16,16);
    //lyricBtn->setCursor(Qt::PointingHandCursor);
    //lyricBtn->setToolTip(QStringLiteral(" 打开歌词 "));
    //lyricBtn->setStyleSheet("QPushButton{background:transparent;border-image:url(:/image/View/image/BottomPlay/lyric.png)}");

    listBtn = new QPushButton;
    listBtn->setFixedSize(19,17);
    listBtn->setCursor(Qt::PointingHandCursor);
    listBtn->setStyleSheet("QPushButton{background:transparent;border-image:url(:/image/View/image/BottomPlay/currentList.png)}");
    ...
    h_mainLayout->addWidget(openBtn,Qt::AlignVCenter);
